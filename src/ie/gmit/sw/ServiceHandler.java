...
public class ServiceHandler extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String strA = req.getParameter("txtS");
		String strB = req.getParameter("txtT");
		...
		if (taskNumber == null){
			...
			outQueue.containsKey(taskNumber);
		}
		...
		out.print("<br>String <i>s</i> : " + strA);
		out.print("<br>String <i>t</i> : " + strB);
		...
		out.print("<input name=\"txtS\" type=\"hidden\" value=\"" + strA + "\">");
		out.print("<input name=\"txtT\" type=\"hidden\" value=\"" + strB + "\">");
